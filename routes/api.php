...
Route::group(['middleware' => ['jwt.verify:admin']], function () { //untuk hak akses admin dan petugas
    ...
    Route::put('masyarakat/{id}', [MasyarakatController::class, 'update']); //update
    ...
    Route::get('pengaduan/report/{limit}/{offset}', [PengaduanController::class, 'laporan']); //get all
...
Route::get('pengaduan/tanggapan/{id}', [TanggapanController::class, 'getTanggapan']); //get all by limit